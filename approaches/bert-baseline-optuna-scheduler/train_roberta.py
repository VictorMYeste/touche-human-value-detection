...
cli = argparse.ArgumentParser(prog="RoBERTa")
...
tokenizer = transformers.RobertaTokenizer.from_pretrained(pretrained_model)
...
trainer = train_with_optuna(training_dataset, validation_dataset, pretrained_model, tokenizer, model_name = args.model_name, n_trials=50)
